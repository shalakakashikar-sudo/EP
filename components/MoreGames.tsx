  ...
  return (
    <div className="bg-white/10 backdrop-blur-sm shadow-2xl rounded-3xl p-8 md:p-12 text-center border-2 border-dark-brown/20 dark:bg-slate-800/50 dark:border-cream/20 animate-fade-in">
      ...
      <div className="my-8 space-y-4">
        ...
        >
            <h2 className="text-2xl font-bold text-teal mb-1">Mind Match</h2>
            <p className="text-dark-brown/80 dark:text-cream/80">Test your memory! Flip cards to match words with their definitions. Race against your own focus.</p>
        </div>
        ...
        >
            <h2 className="text-2xl font-bold text-pink-500 mb-1">Word Scramble</h2>
            <p className="text-dark-brown/80 dark:text-cream/80">Unscramble the jumbled letters to reveal the word or idiom matching the definition!</p>
        </div>
